...
export const metadata = {
  title: 'Team',
  description: 'Faculty, graduate students, and undergraduate researchers of the CORE Lab.',
};
    ...
    <>
      <header className='mx-auto w-full max-w-7xl px-5 pt-10 sm:px-8 lg:px-12'>
        ...
        <p className='mt-2 max-w-2xl leading-7 text-slate-700'>
          Faculty, graduate students, and undergraduate researchers from the University of Toronto and partner institutions.
        </p>
      </header>
