...
const Poster = ({ doi }) => {
  ...
  return (
    <section className='mx-auto max-w-6xl px-5 py-10 sm:px-8 lg:px-12'>
        <h1 className='border-b border-b-slate-200 pb-3 text-center text-2xl font-semibold text-brand'>{poster.title}</h1>
        <div className='grid gap-8 pt-6 lg:grid-cols-[minmax(280px,0.9fr)_1fr] lg:gap-12'>
            ...
            <div className='w-full'>
                <h2 className='mt-2 border-b border-b-slate-200 pb-3 text-xl font-semibold text-brand'>Publication</h2>
